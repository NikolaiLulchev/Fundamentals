...
public class BlackFlags {
    public static void main(String[] args) {
        ...
        if (plunderToThisMoment >= expectedPlunder) {
            System.out.printf("%nAhoy! %.2f plunder gained.", plunderToThisMoment);
        } else {
            double percentOfExpectedPlunder = (plunderToThisMoment / expectedPlunder) * 100;
            System.out.printf("%nCollected only %f%% of the plunder.",percentOfExpectedPlunder);
        }
